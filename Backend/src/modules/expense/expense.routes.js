...
const { list, create, getOne, update, remove, transfer, analytics, trend, exportCsv, uploadReceipt, importCsv, listTags, listComments, createComment, deleteComment } = require('./expense.controller');

const router = Router();
router.get('/analytics/trend', auth, trend);
router.get('/analytics', auth, analytics);
router.get('/export', auth, exportCsv);
router.get('/tags', auth, listTags);

...
const { list, create, getOne, update, remove, analytics, trend, exportCsv, uploadReceipt, importCsv, listTags, listComments, createComment, deleteComment } = require('./expense.controller');
